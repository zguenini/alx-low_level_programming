...
/**
* This help function to print the elf head
* 
* Always Return: nothing
**/
...
/**
* Displays the information contained in the ELF header and run
*  
* 
* Always Return: 0 on success or exit with 98 on failure
**/
